...
[![Valheim: 1.0.16 Verified](https://img.shields.io/badge/Valheim-1.0.16%20verified-blue.svg)](https://github.com/djcdevelopment/TotemSentinel)
[![Version: 1.5.3](https://img.shields.io/badge/Version-1.5.3-brightgreen.svg)](#)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)

**Compatibility:** Valheim 1.0.0-1.0.16; latest build, Harmony target, ZDO field, and isolated boot verification completed on 1.0.16. See the [fleet compatibility evidence](https://github.com/djcdevelopment/deepnorthtesting/blob/main/docs/compatibility/valheim-1.0.16.md).
